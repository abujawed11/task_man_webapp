...
function TaskCard({ task, baseUrl, expanded, toggleDescription, location = 'myTasks' }) {
    ...
    return (
        <div className="h-full flex flex-col justify-between bg-white border border-yellow-500 rounded-xl shadow-md p-2 transition-transform transform hover:scale-105 hover:shadow-yellow-300/60 hover:shadow-2xl hover:ring-2 hover:ring-yellow-300 hover:ring-offset-2">
        ...
        <div className="flex space-x-2">
          ...
          >
            ...
            {/* Header */}
            {/* <div className="bg-yellow-100 p-4 border-b border-yellow-500 flex justify-between gap-4 items-start rounded-t-xl">
                <h3 className="text-xl font-semibold text-black truncate max-w-[70%]">
                    {task.title}
                </h3>
                <div className="flex flex-col items-end gap-1 shrink-0">
                    <button
                        onClick={() =>
                            navigate(`/tasks/${task.task_id}/progress`, { state: { from: location } })
                        }
                    ...
                    <button
                        onClick={() =>
                            navigate(`/tasks/${task.task_id}/update`, { state: { from: location } })
                        }
            ...
            <div className="bg-yellow-100 p-4 border-b border-yellow-500 flex justify-between items-center rounded-t-xl">
                <h3 className="text-xl font-semibold text-black truncate max-w-[65%]">
                    {task.title}
                </h3>
                <div className="flex items-center gap-2 shrink-0 ml-2">
                    <button
                        ...
                        className="text-xs bg-gray-700 text-white px-2 py-1 rounded hover:bg-gray-800 whitespace-nowrap"
                    >
                        View Progress
                    </button>
                    <button
                        ...
                        className="text-xs bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-600 whitespace-nowrap"
                    >
                        Update
                    </button>
                </div>
            ...
            <div className="p-4 flex flex-col justify-between flex-grow space-y-3">
                ...
                {isUser ? (
                    <>
                        ...
                        {task.created_by !== task.assigned_by && (
                            <div className="flex items-center">
                                <UserIcon className="h-5 w-5 text-gray-500 mr-2" />
                                <span className="text-black text-sm">Re-assigned By: {task.assigned_by}</span>
                            </div>
                        )}
                        <div className="flex items-center">
                            <UserIcon className="h-5 w-5 text-gray-500 mr-2" />
